<h1>Implementation of data structures in C</h1>
...
<p>Depth First Search (DFS) is a recursive algorithm that resort to the idea of backtracking. The functionment of this algorithm is based on a sequential and exhaustive search of the nodes by going ahead or, in the other case, by using the principle of backtracking.</p>
